...
const TaxCalculationTable: React.FC<TaxCalculationTableProps> = ({ billData }) => {
  ...
  return (
    <Box className="section" sx={{ mb: 3 }}>
      <Typography variant="h6" sx={{ mb: 2, color: '#2196F3', fontWeight: 'bold', borderBottom: '1px solid #ddd', pb: 1 }} className='section-title'>
        Tax Calculation Details
      </Typography>
      
      <TableContainer component={Paper} sx={{ border: '1px solid #ddd', mb: 2 }}>
        <Table size="small">
          <TableHead>
          ...
          <TableBody>
            {billData.items.map((item, index) => {
              ...
              return (
                <TableRow key={item.id}>
                  ...
                  <TableCell sx={{ textAlign: 'right', fontWeight: 'bold', border: '1px solid #ddd' }}>
            ...
            <TableRow sx={{ bgcolor: '#e3f2fd' }}>
              <TableCell sx={{ fontWeight: 'bold', border: '1px solid #ddd' }} colSpan={5}>
                TOTAL
              </TableCell>
              <TableCell sx={{ textAlign: 'right', fontWeight: 'bold', border: '1px solid #ddd' }}>
              ...
              <TableCell sx={{ textAlign: 'right', fontWeight: 'bold', border: '1px solid #ddd', bgcolor: '#2196F3', color: 'white' }}>
